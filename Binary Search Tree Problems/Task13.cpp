...
class BinarySearchTree{
    private:
        ...
        int returnPartentValue(Node *tree, int data){
            if(tree == NULL){
                return 0;
            }
            ...
            if(tree->left->data == data || tree->right->data == data){
                ...
                returnPartentValue(tree->left, data);
            }
            else{
                returnPartentValue(tree->right, data);
            }
        }
    ...
    public:
        ...
        int returnPartentValue(int data){
            return returnPartentValue(root,data);
        }
};
...
int main(){
    ...
    cout << "Parent Value: " << bst.returnPartentValue(6) << endl;
