...
class BinarySearchTree{
    private:
        ...
        double returnAvgValueofNode(Node *tree){
            if(tree == NULL){
                return 0;
            }
            returnAvgValueofNode(tree->left);
            sum += tree->data;
            count++;
            returnAvgValueofNode(tree->right);
    ...
    public:
        ...
        double returnAvgValueofNode(){
            return returnAvgValueofNode(root);
        }
};
...
int main(){
    ...
    cout << "Average Value: " << bst.returnAvgValueofNode() << endl;
