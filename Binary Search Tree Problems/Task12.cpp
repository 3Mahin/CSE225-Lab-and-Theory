...
class BinarySearchTree{
    private:
        ...
        void pathFromRootToNode(Node *tree, int data){
            if(tree==NULL){
                return;
            }
            ...
            if(tree->data == data){
                ...
                return pathFromRootToNode(tree->left,data);
            }
            else{
                return pathFromRootToNode(tree->right,data);
            }
        }
    ...
    public:
        ...
        void pathFromRootToNode(int data){
            pathFromRootToNode(root,data);
        }
};
